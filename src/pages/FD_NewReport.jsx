...
export default function NewReport() {
  ...
  const handlePreview = () => {
    ...
    setMessage({
      type: "preview",
      text: `Preparing preview for report: ${
        formData.reportName || "Untitled Report"
      }`,
    });
    setTimeout(() => setMessage(null), 3000);
  };
  ...
  const handleGenerateReport = (e) => {
    ...
    if (!formData.reportName || !formData.reportType) {
      setMessage({
        type: "error",
        text: "Please fill out Report Name and Report Type.",
      });
      setTimeout(() => setMessage(null), 3000);
      return;
    }
    ...
    setMessage({
      type: "success",
      text: `Report '${formData.reportName}' generation initiated successfully!`,
    });
  ...
  return (
    <div className="flex flex-col h-screen overflow-y-auto bg-blue-50">
      <FinanceNavbar />
